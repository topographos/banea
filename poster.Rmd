...
*  tools of trade: `PostGIS, SQL, R, QGIS, GRASS, WhiteboxTools, Git`
...
![Figure 5: The physical landscape of the study region consists of the Euphrates floodplain, the lower Euphrates terraces, limestone slopes incised by rivers valleys and the upland plains.](figures/geom_plot_all.png){ width=100% }
...
![Figure 7: Calculated site probability occurrence for each 100 years block.](figures/lcp_aorist_maps.png){ width=100% }
...
# Why R ? 
* integrates space and time (better than GIS)
* seamless workflow for spatial and non-spatial analysis
* GIS bridges
